/*{
    ...
    "INPUTS": [ 
        ...
        { "LABEL": "Anim1/Hardness", "NAME": "mat_hardness", "TYPE": "float", "MIN": 0.0, "MAX": 1.0, "DEFAULT": 0.15 },  
        { "LABEL": "Anim1/Damping", "NAME": "mat_damping", "TYPE": "float", "MIN": 0.0, "MAX": 1.0, "DEFAULT": 0.3 },  
    ],
    "GENERATORS": [
...
{
	float dist = (texCoord.y - mat_damped_value) * 30;
