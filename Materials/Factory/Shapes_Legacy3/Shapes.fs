/*{
    ...
    "INPUTS": [
        ...
        { "LABEL": "Anim/Offset", "NAME": "offset_size", "TYPE": "float", "MIN": 0.0, "MAX": 1.0, "DEFAULT": 1.0 },
        ...
        { "LABEL": "AnimLuma/Offset", "NAME": "offset_luma", "TYPE": "float", "MIN": 0.0, "MAX": 1.0, "DEFAULT": 1.0 },
...
vec4 materialColorForPixel( vec2 texCoord )
{
    ...
    if (animate_luma) {
        ...
        float adjusted_bpm_pos = fract(animation_time - offset_luma * normalizedCellId); // Get full value on beat
