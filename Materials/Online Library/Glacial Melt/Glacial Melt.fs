/*{
    ...
    "DESCRIPTION": "From http:\/\/glslsandbox.com\/e#53656.0",
...
vec3 rota(vec3 gg){
    return vec3(sin(sin(gg.x*10.)+(cos(gg.y*3.2)*2.3)+cos(gg.z*1.3))+sin(gg.x*7.),
            ...
            1.2*cos(gg.y*.9))+sin(gg.x+mat_time*0.1)+cos(gg.z*1.3);
}
...
vec4 materialColorForPixel(vec2 texCoord)
{
    ...
    vec3 gg=vec3(position,mat_time*0.1);
    gg=rota(gg);
    gg=rota(gg.zyx);
    gg=rota(gg.yxz);
    gg=rota(gg);
