/*{
    ...
    "CREDIT": "Joe Griffith",
	"DESCRIPTION": "Digital Follow Spot Squared",
    "TAGS": "Theatrical",
	"VSN": "1.0",
    "INPUTS": [ 
		
		{ "LABEL": "Pan - Tilt", "NAME": "panTilt", "TYPE": "point2D", "MAX": [ 0.69, 0.69 ], "MIN": [ -0.69, -0.69 ], "DEFAULT": [ 0.0, 0.0 ] },		
        { "LABEL": "Diffusion", "NAME": "diffusion", "TYPE": "float", "MIN": 0.0, "MAX": 1.0, "DEFAULT": 0.1 },
...
vec4 materialColorForPixel( vec2 texCoord )
{
	...
	float dist = max(abs(pos.x - uv.x), abs(pos.y - uv.y)) - (iris);
    float o = 1. - smoothstep(0.0,diffusion, dist);    //add diffusion for soft edge
