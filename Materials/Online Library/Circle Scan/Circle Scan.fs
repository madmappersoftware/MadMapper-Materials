/*{
    ...
    "DESCRIPTION": "From http:\/\/glslsandbox.com\/e#44341.0",
...
vec4 materialColorForPixel(vec2 texCoord)
{
    ...
    col = vec3(0.98,0.99,1.00)*sin(uv.y*4.0*pow(mat_pat_y,2.)+mat_time+mat_edge2*clamp(1.0/(mat_edge1*50.0*abs(length(uv.xy)-0.5 * mat_size)), 0.0, 1.0 * mat_edge3)*2.0) * mat_gain;
