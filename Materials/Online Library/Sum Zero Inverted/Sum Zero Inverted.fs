/*{
    "CREDIT": "deerfeeder, adapted by Jason Beyers",

    "DESCRIPTION": "From https://www.shadertoy.com/view/NdVGzR",
    ...
    "INPUTS": [
        ...
        {
            "LABEL": "Animation/Factor 3",
            "NAME": "mat_anim_factor3",
            "TYPE": "float",
            "MIN": 0.0,
            "MAX": 4.0,
            "DEFAULT": 1.0
        ...
        {
            "LABEL": "Animation/Factor 4",
            "NAME": "mat_anim_factor4",
            "TYPE": "float",
            "MIN": 0.0,
            "MAX": 4.0,
            "DEFAULT": 1.0
...
vec4 materialColorForPixel(vec2 texCoord)
{
    ...
    vec3 col = 4.0*cos(mat_time*mat_anim_factor1+uv.xyx*vec3(s*sin(mat_time*0.01*mat_anim_factor2),s*cos(mat_time*0.02*mat_anim_factor3),s*cos(uv.x+mat_time*0.06*mat_anim_factor4)));
       col = abs(col) * mat_fill;
    // Output to screen
    out_color = vec4(vec3(col.x*col.y*col.z),1.0);
