/*{
    ...
    "VSN": "1.6",
    "INPUTS": [
        { "LABEL": "Color/Color Count", "NAME": "mat_color_count", "TYPE": "int", "DEFAULT": 2, "MIN": 1, "MAX": 8 },
        ...
        { "LABEL": "Color/Color 5", "NAME": "mat_color5", "TYPE": "color", "DEFAULT": [ 1.0, 0., 0., 1.0 ] },
        { "LABEL": "Color/Color 6", "NAME": "mat_color6", "TYPE": "color", "DEFAULT": [ 0.027, 0.4, 0., 1.0 ] },
        { "LABEL": "Color/Color 7", "NAME": "mat_color7", "TYPE": "color", "DEFAULT": [ 0.7, 0.64, 0.72, 1.0 ] },
        { "LABEL": "Color/Color 8", "NAME": "mat_color8", "TYPE": "color", "DEFAULT": [ 0.027, 0.64, 0.72, 1.0 ] },
        ...
        { "LABEL": "Global/Scale", "NAME": "mat_base_scale", "TYPE": "float", "MIN": 0.0, "MAX": 200.0, "DEFAULT": 1.0 },
        ...
        { "LABEL": "Move/Sequenced", "NAME": "mat_anim1_sequenced", "TYPE": "bool", "DEFAULT": false, "FLAGS": "button" },
		{ "LABEL": "Move/Seq speed", "NAME": "mat_anim1_seq_speed", "TYPE": "int", "MIN": 0.0, "MAX": 10.0, "DEFAULT": 1. },
...
vec4 materialColorForPixel(vec2 texCoord)
{
	...
	float seq_speed_inv = 1./mat_anim1_seq_speed;
    ...
    if (mat_gradient_mode==0)
        ...
        pos = -length(uv);
    pos *= pow(mat_base_scale,1.) + mat_anim2_level*mat_anim2_level * mat_anim2;

	if (mat_anim1_sequenced==false) {
		pos += 0.5 + mat_base_translate + mat_anim1;
	}
	else {
		pos += 0.5 + mat_base_translate + floor(mat_anim1 * mat_color_count * seq_speed_inv) * stepSize * mat_anim1_seq_speed;
	}
    pos = fract(pos);
