...
vec4 materialColorForPixel(vec2 texCoord)
{
    ...
    float cam_tilt = sin(mat_time*1.2);
    vec3 bh_pos = vec3(0.0,0.0,0.0);
    float bh_rad = 4.0 * mat_size;
    float bh_mass = 0.0015;
    float gravity = 9.0 * pow(mat_gravity,1.5);
    vec2 temp_uv = uv;
    ...
    float hit = 5.0;
    int ahit = 0;
    vec3 ray = vec3(cos(mat_time*0.5)*5.0,sin(mat_time)*6.0,-20.0);
