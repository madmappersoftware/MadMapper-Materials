/*{
  ...
  "INPUTS": [
    ...
    { "LABEL": "Manual Move/Go", "NAME": "mat_manualmovego", "TYPE": "event" },
    { "LABEL": "Manual Move/Size", "NAME": "mat_manualmovesize", "TYPE": "float", "DEFAULT": 0.0, "MIN": 0.0, "MAX": 2.0 },
  ...
  "GENERATORS": [
	...
	{"NAME": "mat_manualmovegoount", "TYPE": "incrementer", "PARAMS": {"increment": "mat_manualmovego"} },
  ]
}*/
...
mat3 makeTransformMatrix(float normalizedCellId)
{
	...
	translateX += mat_manualmovegoount * mat_manualmovesize;
