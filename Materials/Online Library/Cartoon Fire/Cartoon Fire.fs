/*{
    ...
    "VSN": "1.0",
    "INPUTS": [ 
		{ "LABEL": "Speed", "NAME": "mat_speed", "TYPE": "float", "MIN": 0.1, "MAX": 4.0, "DEFAULT": 1.0 }, 
		{ "LABEL": "Scale", "NAME": "mat_scale", "TYPE": "float", "MIN": 0.1, "MAX": 4.0, "DEFAULT": 2.0 }, 
		{ "LABEL": "Offset", "NAME": "mat_offset", "TYPE": "float", "MAX": 4.0, "MIN":-4.0 , "DEFAULT": 0.0 },
		{ "LABEL": "Width", "NAME": "mat_width", "TYPE": "float", "MAX": 1.0, "MIN":-0.0 , "DEFAULT": 0.6 },
...
float getNoise(vec2 uv, float t){
    ...
    float TRAVEL_SPEED = mat_speed;
    
    //octave 1
    float SCALE = mat_scale;
...
vec4 materialColorForPixel( vec2 texCoord )
{
    ...
    CUTOFF = uv.y;    
    //and at horiz edges
    CUTOFF += pow(abs(uv.x*mat_width - 1.),1.0);   
    
    //debugview cutoff field
    //vec4 fragColor = vec4(vec3(CUTOFF),1.0);
