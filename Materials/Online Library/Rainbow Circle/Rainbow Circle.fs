/*{
    ...
    "DESCRIPTION": "From https://www.shadertoy.com/view/3lfGWf",
    ...
    "INPUTS": [
        ...
        {
            "LABEL": "Gradient/Scale X",
            "NAME": "mat_grad_scale_x",
            "TYPE": "float",
            "MIN": 0.0,
            "MAX": 4.0,
            "DEFAULT": 1.0
        ...
        {
            "LABEL": "Gradient/Scale Y",
            "NAME": "mat_grad_scale_y",
            "TYPE": "float",
            "MIN": 0.0,
            "MAX": 4.0,
            "DEFAULT": 1.0
...
vec4 materialColorForPixel(vec2 texCoord)
{
    ...
    float l = length(uv);
    float lg = smoothstep(.5, .4, l * mat_size) * mat_center_scale - .5 * mat_rear_scale;

    float t = mat_time*2.;
    float ofst = (uv.y*10. * mat_grad_scale_x + sin(uv.x*10. * mat_grad_scale_y)*.5) * lg * -1.;
