/*{
	...
	"INPUTS": [
		...
		{"LABEL": "Shape Manager/Shapes Rotate", "NAME": "mat_autorotateoffset", "TYPE": "float", "DEFAULT": 0.0, "MIN": 0.0, "MAX": 90., "DESCRIPTION":"the shape offset is adjusting the rotation offset according to the shape number"},
		...
		{"LABEL": "Bounce/Speed", "NAME": "mat_speedBounce", "TYPE": "float", "MIN": 0.0, "MAX": 2.0, "DEFAULT": 0.2, "DESCRIPTION":"To adjust the speed of the bounce animation"},
		...
		{"LABEL": "Side Bounce/Active", "NAME": "mat_sideBounceActivated", "TYPE": "bool", "DEFAULT": false, "FLAGS": "button", "DESCRIPTION":"The side bounce animation is pivoting the visual with an oscillation, you can add this animation with the auto rotate animation to create pulsating rotation if the speed of the side bounce and the auto rotate are multiples"},
		{"LABEL": "Side Bounce/Speed", "NAME": "mat_speedOsc", "TYPE": "float", "MIN": 0.0, "MAX": 2.0, "DEFAULT": 0.4, "DESCRIPTION":"To adjust the side bounce animation speed"},
		...
		{"LABEL": "Auto Rotate/Speed", "NAME": "mat_autorotatespeed", "TYPE": "float", "DEFAULT": 0.4, "MIN": 0.0, "MAX": 2., "DESCRIPTION":"To adjust the auto rotate speed"},
		...
		{"LABEL": "Color/Grid", "NAME": "mat_button_grid", "TYPE": "long", "DEFAULT":"Const", "VALUES": ["Const","Grad","Osc","Sin 2","Inv 2","Sin 4","Sin 8","Sin 16","Sin 32"],"DESCRIPTION":"You can choose your color Mod. Main : Main Color, Grad : Gradient color per shape between main and secondary color, Osc : Oscillate between main and secondary color in time, Sin : Oscillate between main and secondary color with a sin", "FLAGS": "button_grid" , "FLAGS": "button_grid" },
...
{
	float base_rotation = int(mat_sideBounceActivated)*20*mat_ampOsc*sin(2*PI*mat_timeOsc)+45*mat_button_angle+mat_offsetAngle+shapeNumber*mat_autorotateoffset;
	// Center
