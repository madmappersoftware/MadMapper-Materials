/*{
	...
	"DESCRIPTION": "This is a double sinus for atmospheric visuals",
	"TAGS": "laser",
	"VSN": "1.0",
	"INPUTS": [
		...
		{"LABEL": "Animation/Amplitude", "NAME": "mat_amp", "TYPE": "float", "MIN": 0., "MAX": 2., "DEFAULT": 0.8, "DESCRIPTION":"To adjust the amplitude of the lines"},  
		{"LABEL": "Animation/Speed", "NAME": "mat_speedOffset", "TYPE": "float", "DEFAULT": 0.15, "MIN": -1.0, "MAX": 1.0, "DESCRIPTION":"To adjust the speed of the animation"},
		{"LABEL": "Animation/Frequence", "NAME": "mat_freq", "TYPE": "float", "DEFAULT": 0.5, "MIN": 0., "MAX": 2., "DESCRIPTION":"To adjust the frequency of the lines"},
...
void laserMaterialFunc(int pointNumber, int pointCount, out vec2 pos, out vec4 color, out int shapeNumber, out vec4 userData)
{
	...
	pos = vec2(
		...
		,shapeNumber!=0?mat_amp*0.5*sin(normalizedPosMaxRight*mat_freq*PI)+mat_spread:mat_amp*0.5*sin(normalizedPosMaxLeft*mat_freq*PI)-mat_spread
	);
