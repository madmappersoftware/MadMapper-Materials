/*{
  "INPUTS": [
    ...
    { "LABEL": "Auto Move/Size X", "NAME": "mat_automovesizex", "TYPE": "float", "DEFAULT": 1.0, "MIN": 0.0, "MAX": 1.0 },
    ...
    { "LABEL": "Auto Move/Shape", "NAME": "mat_automoveshape", "TYPE": "long", "VALUES": ["Smooth","In","Linear","Cut","Noise","Smooth In"], "DEFAULT": "Noise" },
    ...
    { "LABEL": "Auto Rotate/Speed", "NAME": "mat_autorotatespeed", "TYPE": "float", "DEFAULT": 0.3, "MIN": 0.0, "MAX": 3.0 },
...
mat3 makeTransformMatrix(float normalizedCellId)
{
    ...
    if (mat_automoveactive) {
      ...
      if (mat_automoveshape == 0) {
        ...
        //translate = autoMoveSize * (0.5 * vec2(dvnoise(vec2((mat_move_position+normalizedCellId*mat_automoveoffset*10),mat_automoveoffset*normalizedCellId*100))));
        translate = autoMoveSize * (0.5 * vec2(noise(vec2((mat_move_position+normalizedCellId*mat_automoveoffset*10),mat_automoveoffset*normalizedCellId*100+0)),
                                               noise(vec2((mat_move_position+normalizedCellId*mat_automoveoffset*10),mat_automoveoffset*normalizedCellId*100+45.6))));
      } else {
