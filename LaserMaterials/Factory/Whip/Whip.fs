/*{
	...
	"DESCRIPTION": "Parametric line moving and rotating for an orgnanic atmospherical visual",
	"TAGS": "laser",
	"VSN": "1.0",
	"INPUTS": [
		...
		{"LABEL": "Animation/Speed", "NAME": "mat_speedAnim", "TYPE": "float", "MIN": 0., "MAX": 2., "DEFAULT": 0.5, "DESCRIPTION":"To adjust the speed of the animation"}, 
		{"LABEL": "Animation/Length", "NAME": "mat_length", "TYPE": "float", "MIN": 0., "MAX": 4., "DEFAULT": 0.7, "DESCRIPTION":"To adjust the length of the lines"}, 
		{"LABEL": "Animation/Mirror", "NAME": "mat_twoLinesButton", "TYPE": "bool", "DEFAULT": false,"FLAGS":"button", "DESCRIPTION":"To add one reversed line"}, 
		{"LABEL": "Animation/Animation mod", "NAME": "mat_insideShift", "TYPE": "point2D", "DEFAULT": [0.75,0.75],"MIN":[-1.,-1.],"MAX":[1.,1.], "DESCRIPTION":"The lines are controled by a parametric function, you can adjust the parameters of the function."}, 
		
		{"LABEL": "Color/Mod", "NAME": "mat_button_grid", "TYPE": "long", "DEFAULT":"Main", "VALUES": ["Main","Grad","Osc","Sin 2","Sin 4","Sin 8","Pulse","Pulse2","Pulse3"], "FLAGS": "button_grid", "DESCRIPTION":"You can choose your color Mod. Main : Main Color, Grad : Gradient color between main and secondary color, Osc : Oscillate between main and secondary color in time, Sin: Oscillates between main and secondary color with a sin and time offset, Pulse : impulsion of color", "FLAGS": "button_grid" },
...
void laserMaterialFunc(int pointNumber, int pointCount, out vec2 pos, out vec4 color, out int shapeNumber, out vec4 userData)
{
	...
	pos = vec2(
		sin((PI+mat_insideShift[0]*0.75+autoShift)*normalizedPosInShapeMax)*autoShift*shapeNumberOSC
		,sin((PI+mat_insideShift[1]*0.75+autoShift2)*normalizedPosInShapeMax)*autoShift2
	);
	pos*=mat_size;
