/*{
	...
	"DESCRIPTION": "This is a rotation cross with dancing looking animation",
	"TAGS": "laser",
	"VSN": "1.0",
	"INPUTS": [
		...
		{"LABEL": "Global/Shape Offset", "NAME": "mat_shapeAngle", "TYPE": "float", "DEFAULT":90., "MIN": 0., "MAX": 180., "DESCRIPTION":"To adjust the output angle of the second line"},
		{"LABEL": "Global/Line Size", "NAME": "mat_size", "TYPE": "float", "MIN": 0., "MAX": 2., "DEFAULT": 0.5, "DESCRIPTION":"To adjust line size"},
		
		{"LABEL": "Lines/Mod", "NAME": "mat_button_AnimMod", "TYPE": "long", "DEFAULT":"2-1", "VALUES": ["1-1","2-1","2-2","3-2","3-3","4-3"], "FLAGS": "button_grid", "DESCRIPTION":"To choose the animation Mod : the animation will swap from n to n-1 or from n to n. You can multiply it with -single double triple- variable"},
		...
		{"LABEL": "Lines/Merge", "NAME": "mat_merge", "TYPE": "bool", "DEFAULT": false, "FLAGS": "button", "DESCRIPTION":"You can choose to merge the lines or to bounce it if unabled"},

		{"LABEL": "Auto Slide/Active", "NAME": "mat_offsetActivated", "TYPE": "bool", "DEFAULT": true, "FLAGS": "button", "DESCRIPTION":"To activate the auto slide animation which act like a bounce inside de visual"},
		...
		{"LABEL": "Color/Secondary", "NAME": "mat_secondaryColor", "TYPE": "color", "DEFAULT": [ .0, 0.0, 0.0, 1.0 ] ,"FLAGS" :"no_alpha", "DESCRIPTION":"To choose the secondary color"},
		{"LABEL": "Color/Alpha", "NAME": "mat_alpha", "TYPE": "float", "DEFAULT": 1.0, "MIN": 0.0, "MAX": 1., "DESCRIPTION":"To choose the secondary color alpha"},
	...
	"GENERATORS": [
		...
		{"NAME": "mat_timeBounce", "TYPE": "time_base", "PARAMS": {"speed": 0.2,"speed_curve": 1,"link_speed_to_global_bpm":true}},
...
{
	float base_rotation = int(mat_sideBounceActivated)*20*mat_ampOsc*sin(2*PI*mat_timeOsc)+45*mat_button_angle+mat_offsetAngle+normalizedCellId*mat_shapeAngle*2.;
	// Center
...
void laserMaterialFunc(int pointNumber, int pointCount, out vec2 pos, out vec4 color, out int shapeNumber, out vec4 userData)
{
	...
	pos = vec2(
		normalizedPosInShapeMax*size
		,customShapeNumber*lineSpreadCustom
	);
	...
	float bounce = pow(abs(sin(PI*mat_timeOscOffset)*mat_ampOscOffset*7.*int(mat_offsetActivated)+tan(freqTan*PI*normalizedPos)),((mat_merge?-sin(2*PI*(mat_timeBounce)):-1))*10);
	
	color = vec4(mix(vec4(mat_secondaryColor.rgb,mat_alpha),vec4(mat_mainColor.rgb,1.),bounce));
		
	if (mat_strobeActivated) {
		color.a *= fract(mat_timeStrobe)<mat_strobeDuration?1.:0.;
	}
