/*{
	"CREDIT": "MadTeam",
	"DESCRIPTION": "Drawing library & sample example",
	"TAGS": "laser",
	"VSN": "1.0",
	"INPUTS": [
		{"LABEL": "Animation/Speed", "NAME": "mat_speed", "TYPE": "float", "DEFAULT": 0.1, "MIN": .0, "MAX": 1.0, "DESCRIPTION":"To adjust the speed of the animation"},
		{"LABEL": "Color/Color 1", "NAME": "mat_color1", "TYPE": "color", "DEFAULT": [1,0,0,1]},
		{"LABEL": "Color/Color 2", "NAME": "mat_color2", "TYPE": "color", "DEFAULT": [0,1,1,1]},
	],
	"GENERATORS": [
		{"NAME": "mat_animation_time", "TYPE": "time_base", "PARAMS": {"speed": "mat_speed"}},
	],
	"RENDER_SETTINGS": {
		"POINT_COUNT": 16000
	},
...
/*
Include Laser Material Shape Library
